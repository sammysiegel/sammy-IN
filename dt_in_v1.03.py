...
class ClassModel(object):
    def __init__(self, n_inputs, h_hidden, n_targets, samples, model, modeldir="."):
        ...
        if 'IN' in self.name:
            ...
            convOneParticle = Conv1D(150,kernel_size=1,activation="relu",name="convOneParticle")(Bpp)
            convTwoParticle = Conv1D(110,kernel_size=1,activation="relu",name="convTwoParticle")(convOneParticle)
            convThreeParticle = Conv1D(75,kernel_size=1,activation="relu",name="convThreeParticle")(convTwoParticle)
            ...
            convPredictOne = Conv1D(150,kernel_size=1,activation="relu",name="convPredictOne")(C)
            convPredictTwo = Conv1D(110,kernel_size=1,activation="relu",name="convPredictTwo")(convPredictOne)

            O = Conv1D(75,kernel_size=1,activation="relu",name="O")(convPredictTwo)
